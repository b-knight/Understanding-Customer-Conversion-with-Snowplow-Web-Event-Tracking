...
[KNeighborsClassifier](http://scikit-learn.org/stable/modules/generated/sklearn.neighbors.KNeighborsClassifier.html#sklearn.neighbors.KNeighborsClassifier) which defaults to n = 5. Regarding what qualifies as a 'neighbor,' KNeighborsClassifier technically uses the [Minkowski distance](https://en.wikipedia.org/wiki/Minkowski_distance), which at its default setttings is effectively the [Euclidean distance](https://en.wikipedia.org/wiki/Euclidean_distance).
